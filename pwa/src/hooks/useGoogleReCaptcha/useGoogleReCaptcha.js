...
const CAPTCHA_CONFIG = {
    "website_key": "6Le4K_oUAAAAAMrcOs1F2xu8jg_24p7t3XtDQf-_",
...
export const useGoogleReCaptcha = props => {
    console.log('useGoogleReCaptcha.js injected');
    ...
    const recaptchaBadge =
        CAPTCHA_CONFIG.badge_position &&
        CAPTCHA_CONFIG.badge_position.length > 0
            ? CAPTCHA_CONFIG.badge_position
            : 'bottomright';
    const recaptchaKey = CAPTCHA_CONFIG.website_key;
    const recaptchaLang = CAPTCHA_CONFIG.language_code;
    const activeForms = CAPTCHA_CONFIG.forms || [];
    const isEnabled =
        recaptchaKey &&
