  ...
  render(props, state) {
    ...
    return html`<li>
      <div class="minicart-product">
        ...
        <div class="info">
          <div class="name"><a href=${`/products/${product.url_key}/${product.sku}`}>${product.name}</a></div>
          <div class="options">
  ...
  render(props, state) {
    ...
    return html`<div class="minicart-panel">
      ...
      <div class="minicart-actions">
        ...
        <button onClick=${() => { window.location.href = '/checkout/cart'; }}>View and edit bag</button>
      </div>
    </div>`;
  }
}
