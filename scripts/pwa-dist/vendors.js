...
return!n.loading&&t&&(n.error?null===(e=t.onError)||void 0===e||e.call(t,n.error):n.data&&(null===(r=t.onCompleted)||void 0===r||r.call(t,n.data))),n}),m=g[0],O=g[1],w=Object(o.useRef)({client:d,query:e,options:t,result:m,previousData:void 0,watchQueryOptions:createWatchQueryOptions(e,t,p)})
...
b(u),o=u.getCurrentResult()}if(o){var l=w.current.result
...
r.d(t,"a",function(){return s}),r.d(t,"b",function(){return x})
...
var s=r||i
return o.a.createElement(s.Provider,{value:u},a)},f=r("wx14"),d=r("zLVn"),p=r("2mql"),h=r.n(p),v=r("TOwV"),y=["getDisplayName","methodName","renderCountProp","shouldHandleStateChanges","storeKey","withRef","forwardRef","context"],b=["reactReduxForwardedRef"],g=[],m=[null,null]
...
return function unsubscribeWrapper(){if(s=!0,r.tryUnsubscribe(),r.onStateChange=null,f)throw f}}}var O=function initStateUpdates(){return[null,0]}
function connectAdvanced(e,t){void 0===t&&(t={})
var r=t,a=r.getDisplayName,u=void 0===a?function(e){return"ConnectAdvanced("+e+")"}:a,l=r.methodName,c=void 0===l?"connectAdvanced":l,s=r.renderCountProp,p=void 0===s?void 0:s,w=r.shouldHandleStateChanges,j=void 0===w||w,S=r.storeKey,k=void 0===S?"store":S,E=(r.withRef,r.forwardRef),x=void 0!==E&&E,C=r.context,P=void 0===C?i:C,_=Object(d.a)(r,y),F=P
return function wrapWithConnect(t){var r=t.displayName||t.name||"Component",i=u(r),a=Object(f.a)({},_,{getDisplayName:u,methodName:c,renderCountProp:p,shouldHandleStateChanges:j,storeKey:k,displayName:i,wrappedComponentName:r,WrappedComponent:t}),l=_.pure
...
return[r.context,e,t]},[r]),u=i[0],l=i[1],c=i[2],p=Object(n.useMemo)(function(){return u&&u.Consumer&&Object(v.isContextConsumer)(o.a.createElement(u.Consumer,null))?u:F},[u,F]),h=Object(n.useContext)(p),y=Boolean(r.store)&&Boolean(r.store.getState)&&Boolean(r.store.dispatch)
Boolean(h)&&Boolean(h.store)
var w=y?r.store:h.store,S=Object(n.useMemo)(function(){return function createChildSelector(t){return e(t.dispatch,a)}(w)},[w]),k=Object(n.useMemo)(function(){if(!j)return m
var e=createSubscription(w,y?null:h.subscription),t=e.notifyNestedSubs.bind(e)
return[e,t]},[w,y,h]),E=k[0],x=k[1],C=Object(n.useMemo)(function(){return y?h:Object(f.a)({},h,{subscription:E})},[y,h,E]),P=Object(n.useReducer)(storeStateUpdatesReducer,g,O),_=P[0][0],I=P[1]
if(_&&_.error)throw _.error
var T=Object(n.useRef)(),R=Object(n.useRef)(c),A=Object(n.useRef)(),M=Object(n.useRef)(!1),L=s(function(){return A.current&&c===R.current?A.current:S(w.getState(),c)},[w,_,c])
useIsomorphicLayoutEffectWithArgs(captureWrapperProps,[R,T,M,c,L,A,x]),useIsomorphicLayoutEffectWithArgs(subscribeUpdates,[j,w,E,S,R,T,M,A,x,I],[w,E,S])
var N=Object(n.useMemo)(function(){return o.a.createElement(t,Object(f.a)({},L,{ref:l}))},[l,t,L])
return Object(n.useMemo)(function(){return j?o.a.createElement(p.Provider,{value:C},N):N},[p,N,C])}var y=l?o.a.memo(ConnectFunction):ConnectFunction
if(y.WrappedComponent=t,y.displayName=ConnectFunction.displayName=i,x){var w=o.a.forwardRef(function forwardConnectRef(e,t){return o.a.createElement(y,Object(f.a)({},e,{reactReduxForwardedRef:t}))})
...
function defaultMergeProps(e,t,r){return Object(f.a)({},r,e,t)}var S=[function whenMergePropsIsFunction(e){return"function"==typeof e?function wrapMergePropsFunc(e){return function initMergePropsProxy(t,r){r.displayName
...
return u=t,n&&(c=r(u,l,a)),c}():c}return function pureFinalPropsSelector(o,s){return p?handleSubsequentCalls(o,s):function handleFirstCall(o,s){return u=e(i=o,a=s),l=t(n,a),c=r(u,l,a),p=!0,c}(o,s)}}function finalPropsSelectorFactory(e,t){var r=t.initMapStateToProps,n=t.initMapDispatchToProps,o=t.initMergeProps,i=Object(d.a)(t,k),a=r(e,i),u=n(e,i),l=o(e,i)
return(i.pure?pureFinalPropsSelectorFactory:impureFinalPropsSelectorFactory)(a,u,l,e,i)}var E=["pure","areStatesEqual","areOwnPropsEqual","areStatePropsEqual","areMergedPropsEqual"]
function match(e,t,r){for(var n=t.length-1;n>=0;n--){var o=t[n](e)
if(o)return o}return function(t,n){throw new Error("Invalid value of type "+typeof e+" for "+r+" argument when connecting component "+n.wrappedComponentName+".")}}function strictEqual(e,t){return e===t}function createConnect(e){var t=void 0===e?{}:e,r=t.connectHOC,n=void 0===r?connectAdvanced:r,o=t.mapStateToPropsFactories,i=void 0===o?j:o,a=t.mapDispatchToPropsFactories,u=void 0===a?w:a,l=t.mergePropsFactories,c=void 0===l?S:l,s=t.selectorFactory,p=void 0===s?finalPropsSelectorFactory:s
return function connect(e,t,r,o){void 0===o&&(o={})
var a=o,l=a.pure,s=void 0===l||l,h=a.areStatesEqual,v=void 0===h?strictEqual:h,y=a.areOwnPropsEqual,b=void 0===y?shallowEqual:y,g=a.areStatePropsEqual,m=void 0===g?shallowEqual:g,O=a.areMergedPropsEqual,w=void 0===O?shallowEqual:O,j=Object(d.a)(a,E),S=match(e,i,"mapStateToProps"),k=match(t,u,"mapDispatchToProps"),x=match(r,c,"mergeProps")
return n(p,Object(f.a)({methodName:"connect",getDisplayName:function getDisplayName(e){return"Connect("+e+")"},shouldHandleStateChanges:Boolean(e),initMapStateToProps:S,initMapDispatchToProps:k,initMergeProps:x,pure:s,areStatesEqual:v,areOwnPropsEqual:b,areStatePropsEqual:m,areMergedPropsEqual:w},j))}}var x=createConnect()
...
var n=r("Ty5D"),o=r("dI71"),i=r("q1tI"),a=r.n(i),u=r("LhCv"),l=(r("17x9"),r("wx14")),c=r("zLVn"),s=r("9R94"),f=function(e){function BrowserRouter(){for(var t,r=arguments.length,n=new Array(r),o=0;o<r;o++)n[o]=arguments[o]
return(t=e.call.apply(e,[this].concat(n))||this).history=Object(u.a)(t.props),t}return Object(o.a)(BrowserRouter,e),BrowserRouter.prototype.render=function render(){return a.a.createElement(n.a,{history:this.history,children:this.props.children})},BrowserRouter}(a.a.Component)
a.a.Component
...
void 0===v&&(v=h)
var y=v(function(e,t){var r=e.innerRef,n=e.navigate,o=e.onClick,i=Object(c.a)(e,["innerRef","navigate","onClick"]),u=i.target,s=Object(l.a)({},i,{onClick:function onClick(e){try{o&&o(e)}catch(t){throw e.preventDefault(),t}e.defaultPrevented||0!==e.button||u&&"_self"!==u||function isModifiedEvent(e){return!!(e.metaKey||e.altKey||e.ctrlKey||e.shiftKey)}(e)||(e.preventDefault(),n())}})
return s.ref=h!==v&&t||r,a.a.createElement("a",s)})
var b=v(function(e,t){var r=e.component,o=void 0===r?y:r,i=e.replace,f=e.to,b=e.innerRef,g=Object(c.a)(e,["component","replace","to","innerRef"])
return a.a.createElement(n.b.Consumer,null,function(e){e||Object(s.a)(!1)
var r=e.history,n=p(d(f,e.location),e.location),c=n?r.createHref(n):"",y=Object(l.a)({},g,{href:c,navigate:function navigate(){var t=d(f,e.location),n=Object(u.e)(e.location)===Object(u.e)(p(t));(i||n?r.replace:r.push)(t)}})
return h!==v?y.ref=t||b:y.innerRef=b,a.a.createElement(o,y)})}),g=function forwardRefShim(e){return e},m=a.a.forwardRef
void 0===m&&(m=g)
m(function(e,t){var r=e["aria-current"],o=void 0===r?"page":r,i=e.activeClassName,u=void 0===i?"active":i,f=e.activeStyle,h=e.className,v=e.exact,y=e.isActive,O=e.location,w=e.sensitive,j=e.strict,S=e.style,k=e.to,E=e.innerRef,x=Object(c.a)(e,["aria-current","activeClassName","activeStyle","className","exact","isActive","location","sensitive","strict","style","to","innerRef"])
return a.a.createElement(n.b.Consumer,null,function(e){e||Object(s.a)(!1)
var r=O||e.location,i=p(d(k,r),r),c=i.pathname,C=c&&c.replace(/([.+*?=^!:${}()[\]|/\\])/g,"\\$1"),P=C?Object(n.c)(r.pathname,{path:C,exact:v,sensitive:w,strict:j}):null,_=!!(y?y(P,r):P),F=_?function joinClassnames(){for(var e=arguments.length,t=new Array(e),r=0;r<e;r++)t[r]=arguments[r]
return t.filter(function(e){return e}).join(" ")}(h,u):h,I=_?Object(l.a)({},S,f):S,T=Object(l.a)({"aria-current":_&&o||null,className:F,style:I,to:i},x)
return g!==m?T.ref=t||E:T.innerRef=E,a.a.createElement(b,T)})})},"56Qq":function(e,t,r){"use strict"
...
return("x"==e?t:3&t|8).toString(16)})},T=function computeFieldFromProperty(e,t,r){var n=t["ui:control"],o=t["informed:props"],i=t["input:props"],a=t["ui:before"],u=t["ui:after"],l=t.oneOf,c=t.items,s=t.enum,f=t.title,d=t.minimum,p=t.maximum,h=t.minLength,v=t.maxLength,y=t.pattern,b=t.type,g=t.properties,m=I()
i&&i.id&&(m=i.id)
var O={componentType:n,field:r?"".concat(r,".").concat(e):e,type:b,uiBefore:a,uiAfter:u,properties:"object"===b?g:void 0,items:"array"===b?c:void 0,props:_objectSpread2(_objectSpread2({label:f,id:m,min:d,max:p,minLength:h,maxLength:v,pattern:y},o),i)}
...
return T(e,t,r)})
return i&&l.push({componentType:"conditionals",allOf:i}),l}return[]},A=function informedFormat(e,t){if(!e)return{value:e,offset:0}
...
if(""!==i||j||o.allowEmptyString||a.allowEmptyStrings||(i=void 0),"number"!==e.type&&"number"!==T||void 0===i||(i=+i),n&&n.target&&n.target.selectionStart&&Ae(n.target.selectionStart),l&&!w&&(u=l(i,Re()),i=l(i,Re())),c&&!w){var h=c(i,Re())
u=h.value,i=h.value,Me(h.offset)}if(s&&f&&(i=f(i),u=s(i)),d){var v=A(i,d)
Me(v.offset),i=u=v.value}p&&(i=null!=i?p(i):i),ce&&b&&!o.initial&&(N("Validating after change ".concat(r," ").concat(i)),We(ce(i,ne.getValues()))),he(i),xe(u),S&&S(i),ee.setValue(Z,i,!o.preventUpdate)},Ue=function setTouched(e,t){var n=(arguments.length>2&&void 0!==arguments[2]?arguments[2]:{}).preventUpdate
if(N("Field ".concat(r," has been touched")),ce&&g&&!t&&e&&(N("Validating after blur ".concat(r," ").concat(qe())),We(ce(qe(),ne.getValues()))),a&&O&&!t&&e&&(N("Validating async after blur ".concat(r," ").concat(qe())),a(qe(),ne.getValues())),l&&w){var o=l(qe())
he(o),xe(o),S&&S(o),ee.setValue(Z,o,!n)}if(c&&w){var i=c(qe())
Me(i.offset),he(i.value),xe(i.value),S&&S(i.value),ee.setValue(Z,i.value,!n)}je(e),ee.setTouched(Z,e,!n)},He={setValue:Be,setTouched:Ue,setError:We,reset:function reset(){var e=(arguments.length>0&&void 0!==arguments[0]?arguments[0]:{}).preventUpdate,t=D(Ce.current||ee.getInitialValue(Pe.current),l,d,p,Y)
...
_&&(Ge={error:be,touched:we}),N("Render",ne.getFullField(r),Ge),M(function(){var e=ne.getFullField(Pe.current)
...
return ie.current?ie.current=!1:(N("Update",r,re),ae.current.field=e,ee.update(Z,ae.current,_e.current)),function(){_e.current=e}},[r]),M(function(){P&&Ie&&(Ie.current.style.border="5px solid orange",setTimeout(function(){Ie.current.style.borderWidth="2px",Ie.current.style.borderStyle="inset",Ie.current.style.borderColor="initial",Ie.current.style.borderImage="initial"},500))})
var Ke=[].concat(_toConsumableArray(Object.values(Ge)),_toConsumableArray(Object.values(e)),_toConsumableArray(Object.values(X))),$e=r,Je=V({fieldType:T,setValue:Be,onChange:U,multiple:R,ref:Ie}),Ye=q({setTouched:Ue,onBlur:H}),Xe=W({fieldType:T,maskedValue:Ee,multiple:R,value:pe}),Ze=B(T)
...
return t.displayName="asField(".concat(E(e),")"),t},G=a("informed:Text\t"),K=H(function Text(e){var t=e.fieldApi,r=e.fieldState,n=_objectWithoutProperties(e,["fieldApi","fieldState"]),i=r.maskedValue,a=t.setValue,u=t.setTouched,l=n.onChange,c=n.onBlur,s=n.field,f=(n.initialValue,n.forwardedRef),d=n.debug,p=n.label,h=(n.title,n.id),v=_objectWithoutProperties(n,["onChange","onBlur","field","initialValue","forwardedRef","debug","label","title","id"])
return G("Render",s),M(function(){d&&f&&(f.current.style.background="red",setTimeout(function(){f.current.style.background="white"},500))}),o.a.createElement(o.a.Fragment,null,p?o.a.createElement("label",{htmlFor:h}," ",p," "):null,o.a.createElement("input",_extends({},v,{id:h,name:s,ref:f,value:i||0===i?i:"",onChange:function onChange(e){a(e.target.value,e),l&&l(e)},onBlur:function onBlur(e){u(!0),c&&c(e)}})))}),$=H(function TextArea(e){var t=e.fieldApi,r=e.fieldState,n=_objectWithoutProperties(e,["fieldApi","fieldState"]),i=r.maskedValue,a=t.setValue,u=t.setTouched,l=n.onChange,c=n.onBlur,s=n.field,f=(n.initialValue,n.forwardedRef),d=n.debug,p=n.label,h=n.id,v=_objectWithoutProperties(n,["onChange","onBlur","field","initialValue","forwardedRef","debug","label","id"])
return M(function(){d&&f&&(f.current.style.background="red",setTimeout(function(){f.current.style.background="white"},500))}),o.a.createElement(o.a.Fragment,null,p?o.a.createElement("label",{htmlFor:h}," ",p," "):null,o.a.createElement("textarea",_extends({},v,{id:h,name:s,ref:f,value:i||"",onChange:function onChange(e){a(e.target.value,e),l&&l(e)},onBlur:function onBlur(e){u(!0),c&&c(e)}})))}),J=a("informed:Select\t"),Y=H(function Select(e){var t=e.fieldApi,r=e.fieldState,i=_objectWithoutProperties(e,["fieldApi","fieldState"]),a=r.value,u=t.setTouched,l=i.onChange,c=i.onBlur,s=i.field,f=(i.initialValue,i.options),d=i.children,p=i.forwardedRef,h=i.debug,v=i.multiple,y=i.label,b=i.id,g=_objectWithoutProperties(i,["onChange","onBlur","field","initialValue","options","children","forwardedRef","debug","multiple","label","id"]),m=Object(n.useRef)()
return M(function(){h&&p&&(p.current.style.background="red",setTimeout(function(){p.current.style.background="white"},500))}),J("Render",s,a),o.a.createElement(o.a.Fragment,null,y?o.a.createElement("label",{htmlFor:b}," ",y," "):null,o.a.createElement("select",_extends({},g,{id:b,multiple:v,name:s,ref:p||m,value:a||(v?[]:""),onChange:function handleChange(e){var r=Array.from((p||m).current).filter(function(e){return e.selected}).map(function(e){return e.value})
...
j[e]&&j[r]?(n[e]=j[r],n[r]=j[e]):console.warn("Attempted to swap ".concat(e," with ").concat(r," but one of them does not exist :(")),S(n)},P=function add(){j.push(I()),S(_toConsumableArray(j))},_=function addWithInitialValue(e){j.push(I()),S(_toConsumableArray(j))
var t=_toConsumableArray(g())
t[j.length-1]=e,b(t)},F=j.map(function(e,r){var n={remove:function remove(){return function remove(e){te("EXPECTING REMOVAL OF","".concat(t,"[").concat(e,"] and ").concat(t,"[").concat(j.length-1,"]")),s.expectRemoval("".concat(t,"[").concat(e,"]")),s.expectRemoval("".concat(t,"[").concat(j.length-1,"]"))
...
S(n)}}
a&&(a.current=T)
var R={fields:F,field:t},A=_objectSpread2(_objectSpread2({},s),{},{register:function register(e,t){c.set(e,t)
for(var r=arguments.length,n=new Array(r>2?r-2:0),o=2;o<r;o++)n[o-2]=arguments[o]
s.register.apply(s,[e,t].concat(n))},deregister:function deregister(e){c.delete(e)
for(var t=arguments.length,r=new Array(t>1?t-1:0),n=1;n<t;n++)r[n-1]=arguments[n]
s.deregister.apply(s,[e].concat(r))},getInitialValue:function getInitialValue(e){if(RegExp("".concat(f,"\\[[0-9]+\\]")).test(e)){var r=e.replace(t,""),n=v.get(g(),r)
...
for(var t=arguments.length,r=new Array(t>1?t-1:0),n=1;n<t;n++)r[n-1]=arguments[n]
a.deregister.apply(a,[e].concat(r))}}),b=_objectSpread2(_objectSpread2(_objectSpread2({},r),d),{},{reset:function reset(){s.forEach(function(e){e.fieldApi.reset()})}}),g=_objectSpread2(_objectSpread2({},t),p)
...
return t||(console.warn("Attempting to get field ".concat(e," but it does not exist")),this.dummyField)}},{key:"notify",value:function notify(e){var t=this,r=this.getField(e)
...
this.fieldsById.forEach(function(e,t){e&&e.field===n&&(i=t)}),i&&(t.keepState||t.inMultistep)?(pe("Already Registered",n),this.fieldsById.delete(i)):!i||t.keepState&&t.inMultistep||console.warn("Check to make sure you have not registered two fields with the fieldName",n),pe("Fields Registered",this.fieldsById.size),this.onScreen[e]=t,this.fieldsById.set(e,t),pe("clearing expected removal",a),delete this.expectedRemovals[a],delete this.pulledOut[a],t.shadow||(this.updater.setValue(e,t.fieldApi.getValue(),!1),this.updater.setError(e,t.fieldApi.getError(),!1),this.updater.setTouched(e,t.fieldApi.getTouched(),!1),r||this.emit("change"))}},{key:"deregister",value:function deregister(e){var t=this.fieldsById.get(e),r=t.field
...
M(function(){var e=function onChangeHandler(){return f&&f(S.getFormState())},t=function onResetHandler(){return d&&d()},r=function onSubmitHandler(){return p&&p(S.getFormState().values)},n=function onValueHandler(){return h&&h(S.getFormState().values)},o=function onFailureHandler(){return v&&v(S.getFormState().errors)}
return S.on("change",e),S.on("reset",t),S.on("submit",r),S.on("value",n),S.on("failure",o),function(){S.removeListener("change",e),S.removeListener("reset",t),S.removeListener("submit",r),S.removeListener("value",n),S.removeListener("failure",o)}},[f,d,p,h,v]),Object(n.useState)(function(){S.on("change",function onChangeHandlerRerender(){ge("Setting form state"),x(S.getFormState())}),c&&c(S.getFormApi()),s&&(s.current=S.getFormApi())})
var C=_slicedToArray(Object(n.useState)(function(){return S.getFormApi()}),1)[0]
return{formApi:C,formState:E,formController:S,render:function render(e){return o.a.createElement(be,{formApi:C,formState:E,formController:S},o.a.createElement(o.a.Fragment,null,e||o.a.createElement(se,{schema:b,onlyValidateSchema:O})))},userProps:w}},Oe=a("informed:Form\t\t"),we=function Form(e){var t=e.children,r=e.render,n=e.component,i=_objectWithoutProperties(e,["children","render","component"])
Oe("Render FORM")
...
default:return null}}},DbnI:function(e,t,r){"use strict";(function(e,n){var o,i=r("0xFR")
...
var F=r("L2ys"),I=r("mph4"),T=r("CuOm"),R=r("uiNf"),A=function(){function LocalState(e){var t=e.cache,r=e.client,n=e.resolvers,o=e.fragmentMatcher
...
void 0!==t&&l.push(((r={})[Object(g.i)(e)]=t,r))})]:(Object(g.f)(e)?c=e:(c=i[e.name.value],Object(o.b)(c,"No fragment named ".concat(e.name.value))),c&&c.typeCondition&&(s=c.typeCondition.name.value,r.fragmentMatcher(t,s,a))?[2,this.resolveSelectionSet(c.selectionSet,t,r).then(function(e){l.push(e)})]:[2]):[2]})})},[2,Promise.all(e.selections.map(c)).then(function(){return Object(I.c)(l)})]})})},LocalState.prototype.resolveField=function(e,t,r){return Object(n.b)(this,void 0,void 0,function(){var o,i,a,u,l,c,s,f,d,p=this
return Object(n.d)(this,function(n){return o=r.variables,i=e.name.value,a=Object(g.i)(e),u=i!==a,l=t[a]||t[i],c=Promise.resolve(l),r.onlyRunForcedResolvers&&!this.shouldForceResolvers(e)||(s=t.__typename||r.defaultOperationType,(f=this.resolvers&&this.resolvers[s])&&(d=f[u?i:a])&&(c=Promise.resolve(R.a.withValue(this.cache,d,[t,Object(g.a)(e,o),r.context,{field:e,fragmentMap:r.fragmentMap}])))),[2,c.then(function(t){return void 0===t&&(t=l),e.directives&&e.directives.forEach(function(e){"export"===e.name.value&&e.arguments&&e.arguments.forEach(function(e){"as"===e.name.value&&"StringValue"===e.value.kind&&(r.exportedVariables[e.value.value]=t)})}),e.selectionSet?null==t?t:Array.isArray(t)?p.resolveSubSelectedArray(e,t,r):e.selectionSet?p.resolveSelectionSet(e.selectionSet,t,r):void 0:t})]})})},LocalState.prototype.resolveSubSelectedArray=function(e,t,r){var n=this
return Promise.all(t.map(function(t){return null===t?null:Array.isArray(t)?n.resolveSubSelectedArray(e,t,r):e.selectionSet?n.resolveSelectionSet(e.selectionSet,t,r):void 0}))},LocalState}(),M=new(p.b?WeakMap:Map)
...
return!(r&&r.dmCount===M.get(this.cache)&&Object(f.a)(t,r.variables)&&Object(f.a)(e.data,r.result.data))},QueryInfo.prototype.markResult=function(e,t,r){var n=this
...
case 2:return u=this.mutationStore&&(this.mutationStore[e]={mutation:t,variables:r,loading:!0,error:null}),i&&this.markMutationOptimistic(i,{mutationId:e,document:t,variables:r,fetchPolicy:y,errorPolicy:h,context:g,updateQueries:a,update:f,keepRootFields:b}),this.broadcastQueries(),c=this,[2,new Promise(function(o,p){return asyncMap(c.getObservableFromLink(t,Object(n.a)(Object(n.a)({},g),{optimisticResponse:i}),r,!1),function(o){if(graphQLResultHasError(o)&&"none"===h)throw new S.a({graphQLErrors:o.errors})
u&&(u.loading=!1,u.error=null)
var p=Object(n.a)({},o)
return"function"==typeof l&&(l=l(p)),"ignore"===h&&graphQLResultHasError(p)&&delete p.errors,c.markMutationResult({mutationId:e,result:p,document:t,variables:r,fetchPolicy:y,errorPolicy:h,context:g,update:f,updateQueries:a,awaitRefetchQueries:s,refetchQueries:l,removeOptimistic:i?e:void 0,onQueryUpdated:d,keepRootFields:b})}).subscribe({next:function(e){c.broadcastQueries(),o(e)},error:function(t){u&&(u.loading=!1,u.error=t),i&&c.cache.removeOptimistic(e),c.broadcastQueries(),p(t instanceof S.a?t:new S.a({networkError:t}))}})})]}})})},QueryManager.prototype.markMutationResult=function(e,t){var r=this
...
y.set(b,u=g),g.cleanup(function(){y.delete(b)&&y.size<1&&s.delete(c)})}}else u=new w([a(f,p)])}else u=new w([h.a.of({data:{}})]),t=this.prepareContext(t)
...
var o=this.transform(t.query).document,i=this.getVariables(o,t.variables),a=this.getQuery(e),u=t.fetchPolicy,l=void 0===u?"cache-first":u,c=t.errorPolicy,s=void 0===c?"none":c,f=t.returnPartialData,d=void 0!==f&&f,p=t.notifyOnNetworkStatusChange,h=void 0!==p&&p,v=t.context,y=void 0===v?{}:v,b=Object.assign({},t,{query:o,variables:i,fetchPolicy:l,errorPolicy:s,returnPartialData:d,notifyOnNetworkStatusChange:h,context:y}),g=function(e){return b.variables=e,n.fetchQueryByPolicy(a,b,r)}
...
var y=function(){return e.getDiff(a)},b=function(t,r){void 0===r&&(r=e.networkStatus||k.a.loading)
var u=t.result
...
return u&&o.transform(i).hasForcedResolvers?o.localState.runResolvers({document:i,remoteResult:{data:u},context:d,variables:a,onlyRunForcedResolvers:!0}).then(function(e){return l(e.data||void 0)}):l(u)},g="no-cache"===u?0:r===k.a.refetch&&"merge"!==l?1:2,m=function(){return o.getResultsFromLink(e,g,{variables:a,context:d,fetchPolicy:u,errorPolicy:c})},O=p&&"number"==typeof v&&v!==r&&Object(k.b)(r)
switch(u){default:case"cache-first":return(w=y()).complete?[b(w,e.markReady())]:s||O?[b(w),m()]:[m()]
case"cache-and-network":var w
return(w=y()).complete||s||O?[b(w),m()]:[m()]
...
var o=t.type
return o&&-1!==n.indexOf(v(o))?(!0===t.error?l:u)(e,t):e}}(e,Object(b.a)(e,o),t)}),g=n.a.apply(void 0,c.concat([t]))
...
var l=function getDEV(){try{return Boolean(!0)}catch(e){return Object.defineProperty(o.a,u,{value:"production"!==Object(i.a)(function(){return"production"}),enumerable:!1,configurable:!0,writable:!0}),o.a[u]}}(),c=r("ePnf"),s=r("neE4")
!function removeTemporaryGlobals(){return s.a,Object(c.a)()}(),function checkDEV(){Object(n.b)("boolean"==typeof l,l)}()},j7o3:function(e,t,r){"use strict"
var n=r("q1tI"),o=r.n(n),i=r("17x9"),a=r.n(i)
function _extends(){return(_extends=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var r=arguments[t]
for(var n in r)Object.prototype.hasOwnProperty.call(r,n)&&(e[n]=r[n])}return e}).apply(this,arguments)}function _objectWithoutProperties(e,t){if(null==e)return{}
var r,n,o=function _objectWithoutPropertiesLoose(e,t){if(null==e)return{}
...
return null==i?o:(r.writeFragment(Object(n.a)(Object(n.a)({},e),{data:i})),i)}})},ApolloCache}(),c=function(){return function MissingFieldError(e,t,r,n){this.message=e,this.path=t,this.query=r,this.variables=n}}(),s=r("56Qq"),f=r("BAPW"),d=r("zf2e"),p=r("zKVw"),h=r("sHDe"),v=r("mph4"),y=r("QcCY"),b=r("RiOv")
...
throw e}return e}(e)===e&&Object.getOwnPropertyNames(e).forEach(function(r){Object(b.a)(e[r])&&t.add(e[r])})}),e}function maybeDeepFreeze(e){return deepFreeze(e),e}var g,m,O=r("5YkO"),w=r("8CQ5"),j=Object.create(null),S=function(){return j},k=Object.create(null),E=function(){function EntityStore(e,t){var r=this
...
if(!r)return t
var n=new Set([r])
n.forEach(function(e){Object(s.g)(e)&&(t[e.__ref]=!0),Object(b.a)(e)&&Object.keys(e).forEach(function(t){var r=e[t]
...
function makeDepKey(e,t){return t+"#"+e}function maybeDependOnExistenceOfEntity(e,t){supportsResultCaching(e)&&e.group.depend(t,"__exists")}g=E||(E={}),m=function(e){function Root(t){var r=t.policies,n=t.resultCaching,o=void 0===n||n,i=t.seed,a=e.call(this,r,new x(o))||this
...
var b,g=Object(s.h)(i),m=new v.a,O=this.executeSelectionSet({selectionSet:Object(h.e)(r).selectionSet,objectOrReference:g,enclosingRef:g,context:{store:t,query:r,policies:y,variables:a,varString:Object(_.b)(a),canonizeResults:p,fragmentMap:Object(u.a)(Object(h.d)(r)),merge:function(e,t){return m.merge(e,t)}}})
if(O.missing&&(b=[new c(firstMissing(O.missing),O.missing,r,a)],!f))throw b[0]
return{result:O.result,complete:!b,missing:b}},StoreReader.prototype.isFresh=function(e,t,r,n){if(supportsResultCaching(n.store)&&this.knownResults.get(e)===r){var o=this.executeSelectionSet.peek(r,t,n,this.canon.isKnown(e))
...
if(Object(y.c)(e,l))if(Object(s.e)(e)){var b=c.readField({fieldName:e.name.value,field:e,variables:i.variables,from:n},i),g=Object(s.i)(e)
void 0===b?f.a.added(e)||(a=i.merge(a,((r={})[g]="Can't find field '".concat(e.name.value,"' on ").concat(Object(s.g)(n)?n.__ref+" object":"object "+JSON.stringify(n,null,2)),r))):Object(w.f)(b)?b=handleMissing(t.executeSubSelectedArray({field:e,array:b,enclosingRef:o,context:i}),g):e.selectionSet?null!=b&&(b=handleMissing(t.executeSelectionSet({selectionSet:e.selectionSet,objectOrReference:b,enclosingRef:Object(s.g)(b)?b:o,context:i}),g)):i.canonizeResults&&(b=t.canon.pass(b)),void 0!==b&&(p=i.merge(p,((v={})[g]=b,v)))}else{var m=Object(u.b)(e,i.fragmentMap)
m&&c.fragmentMatches(m,d)&&m.selectionSet.selections.forEach(h.add,h)}})
var v={result:p,missing:a},b=i.canonizeResults?this.canon.admit(v):maybeDeepFreeze(v)
return b.result&&this.knownResults.set(b.result,r),b},StoreReader.prototype.execSubSelectedArrayImpl=function(e){var t,r=this,n=e.field,i=e.array,a=e.enclosingRef,u=e.context
...
n.forEach(function(r){Object(b.a)(r)&&(Object(o.b)(!Object(s.g)(r),"Missing selection set for object of type ".concat(Object(w.d)(e,r)," returned for query field ").concat(t.name.value)),Object.values(r).forEach(n.add,n))})}}(u.store,n,e),e)}),{result:u.canonizeResults?this.canon.admit(i):i,missing:t}},StoreReader}()
...
var A=r("uiNf"),M=Object.create(null)
function lookupSpecifierInfo(e){var t=JSON.stringify(e)
return M[t]||(M[t]=Object.create(null))}function keyFieldsFnFromSpecifier(e){var t=lookupSpecifierInfo(e)
...
return A.a.withValue(this.cache,l,[a,c])}return a}},Policies.prototype.getReadFunction=function(e,t){var r=this.getFieldPolicy(e,t,!1)
...
if(Object(b.a)(t)&&Object(b.a)(r)){var i=e.getFieldValue(t,"__typename"),a=e.getFieldValue(r,"__typename")
if(i&&a&&i!==a)return r
...
return i||e.flavors.set(o,i=e.clientOnly===t&&e.deferred===r?e:Object(n.a)(Object(n.a)({},e),{clientOnly:t,deferred:r})),i}var V=function(){function StoreWriter(e,t){this.cache=e,this.reader=t}return StoreWriter.prototype.writeToStore=function(e,t){var r=this,i=t.query,l=t.result,c=t.dataId,f=t.variables,d=t.overwrite,p=Object(h.f)(i),v=Object(w.g)()
f=Object(n.a)(Object(n.a)({},Object(h.b)(p)),f)
var y={store:e,written:Object.create(null),merge:function(e,t){return v.merge(e,t)},variables:f,varString:Object(_.b)(f),fragmentMap:Object(u.a)(Object(h.d)(i)),overwrite:!!d,incomingById:new Map,clientOnly:!1,deferred:!1,flavors:new Map},b=this.processSelectionSet({result:l||Object.create(null),dataId:c,selectionSet:p.selectionSet,mergeTree:{map:new Map},context:y})
if(!Object(s.g)(b))throw new o.a("Could not identify object ".concat(JSON.stringify(l)))
...
o.b.warn("Cache data may be lost when replacing the ".concat(f," field of a ").concat(c," object.\n\nTo address this problem (which is not a bug in Apollo Client), ").concat(p.length?"either ensure all objects of type "+p.join(" and ")+" have an ID or a custom merge function, or ":"","define a custom merge function for the ").concat(d," field, so InMemoryCache can safely merge these objects:\n\n  existing: ").concat(JSON.stringify(u).slice(0,1e3),"\n  incoming: ").concat(JSON.stringify(l).slice(0,1e3),"\n\nFor more information about these options, please refer to the documentation:\n\n  * Ensuring entity objects have IDs: https://go.apollo.dev/c/generating-unique-identifiers\n  * Defining custom merge functions: https://go.apollo.dev/c/merging-non-normalized-objects\n"))}(c,i,e,y.store)})}e.merge(n,i)}),e.retain(b.__ref),b},StoreWriter.prototype.processSelectionSet=function(e){var t=this,r=e.dataId,i=e.result,a=e.selectionSet,u=e.context,l=e.mergeTree,c=this.cache.policies,d=Object.create(null),p=r&&c.rootTypenamesById[r]||Object(s.c)(i,a,u.fragmentMap)||r&&u.store.get(r,"__typename")
...
if(v.add(r),void 0!==u){var y=c.getStoreFieldName({typename:p,fieldName:r.name.value,field:r,variables:e.variables}),b=getChildMergeTree(l,y),g=t.processFieldValue(u,r,r.selectionSet?getContextFlavor(e,!1,!1):e,b),m=void 0
r.selectionSet&&(Object(s.g)(g)||Object(w.k)(g))&&(m=h("__typename",g))
var O=c.getMergeFunction(p,r.name.value,m)
O?b.info={field:r,typename:p,merge:O}:maybeRecycleChildMergeTree(l,y),d=e.merge(d,((n={})[y]=g,n))}else e.clientOnly||e.deferred||f.a.added(r)||c.getReadFunction(p,r.name.value)||o.b.error("Missing field '".concat(Object(s.i)(r),"' while writing result ").concat(JSON.stringify(i,null,2)).substring(0,1e3))})
try{var y=c.identify(i,{typename:p,selectionSet:a,fragmentMap:u.fragmentMap,storeObject:d,readField:h}),b=y[0],g=y[1]
r=r||b,g&&(d=u.merge(d,g))}catch(e){if(!r)throw e}if("string"==typeof r){var m=Object(s.h)(r),O=u.written[r]||(u.written[r]=[])
...
return r.watches=new Set,r.typenameDocumentCache=new Map,r.makeVar=A.c,r.txCount=0,r.config=Object(w.h)(t),r.addTypename=!!r.config.addTypename,r.policies=new Q({cache:r,dataIdFromObject:r.config.dataIdFromObject,possibleTypes:r.config.possibleTypes,typePolicies:r.config.typePolicies}),r.init(),r}return Object(n.c)(InMemoryCache,e),InMemoryCache.prototype.init=function(){var e=this.data=new E.Root({policies:this.policies,resultCaching:this.config.resultCaching})
...
return this.watches.size||Object(A.d)(this),this.watches.add(e),e.immediate&&this.maybeBroadcastWatch(e),function(){t.watches.delete(e)&&!t.watches.size&&Object(A.b)(t),t.maybeBroadcastWatch.forget(e)}},InMemoryCache.prototype.gc=function(e){_.b.reset()
...
return this.init(),_.b.reset(),e&&e.discardWatches?(this.watches.forEach(function(e){return t.maybeBroadcastWatch.forget(e)}),this.watches.clear(),Object(A.b)(this)):this.broadcastWatches(),Promise.resolve()},InMemoryCache.prototype.removeOptimistic=function(e){var t=this.optimisticData.removeLayer(e)
...
var t=e.uri,r=void 0===t?"/graphql":t,f=e.fetch,v=e.print,y=void 0===v?p:v,b=e.includeExtensions,g=e.useGETForQueries,m=e.includeUnusedVariables,O=void 0!==m&&m,w=Object(n.e)(e,["uri","fetch","print","includeExtensions","useGETForQueries","includeUnusedVariables"]);(function(e){if(!e&&"undefined"==typeof fetch)throw new o.a("\n\"fetch\" has not been found globally and no fetcher has been configured. To fix this, install a fetch package (like https://www.npmjs.com/package/cross-fetch), instantiate the fetcher, and pass it into your HttpLink constructor. For example:\n\nimport fetch from 'cross-fetch';\nimport { ApolloClient, HttpLink } from '@apollo/client';\nconst client = new ApolloClient({\n  link: new HttpLink({ uri: '/graphql', fetch })\n});\n    ")})(f||h)
...
if(a.clientAwareness){var v=a.clientAwareness,b=v.name,m=v.version
b&&(p["apollographql-client-name"]=b),m&&(p["apollographql-client-version"]=m)}var w,S=Object(n.a)(Object(n.a)({},p),a.headers),k={http:a.http,options:a.fetchOptions,credentials:a.credentials,headers:S},E=selectHttpOptionsAndBodyInternal(e,y,d,j,k),x=E.options,C=E.body
...
return{controller:e,signal:e.signal}}(),F=_.controller,I=_.signal;(w=F)&&(x.signal=I)}if(g&&!e.query.definitions.some(function(e){return"OperationDefinition"===e.kind&&"mutation"===e.operation})&&(x.method="GET"),"GET"===x.method){var T=function rewriteURIForGET(e,t){var r=[],n=function(e,t){r.push("".concat(e,"=").concat(encodeURIComponent(t)))}
...
if(null!=t){if(void 0!==t.ref&&(u=t.ref,l=b.current),void 0!==t.key&&(a=""+t.key),e.type&&e.type.defaultProps)var c=e.type.defaultProps
for(s in t)g.call(t,s)&&!m.hasOwnProperty(s)&&(i[s]=void 0===t[s]&&void 0!==c?c[s]:t[s])}var s=arguments.length-2
if(1===s)i.children=r
...
e&&(e.stopPropagation?e.stopPropagation():"unknown"!=typeof e.cancelBubble&&(e.cancelBubble=!0),this.isPropagationStopped=pd)},persist:function(){},isPersistent:pd}),b}var _t,Ft,It,Tt={eventPhase:0,bubbles:0,cancelable:0,timeStamp:function(e){return e.timeStamp||Date.now()},defaultPrevented:0,isTrusted:0},Rt=rd(Tt),At=a({},Tt,{view:0,detail:0}),Mt=rd(At),Lt=a({},At,{screenX:0,screenY:0,clientX:0,clientY:0,pageX:0,pageY:0,ctrlKey:0,shiftKey:0,altKey:0,metaKey:0,getModifierState:zd,button:0,buttons:0,relatedTarget:function(e){return void 0===e.relatedTarget?e.fromElement===e.srcElement?e.toElement:e.fromElement:e.relatedTarget},movementX:function(e){return"movementX"in e?e.movementX:(e!==It&&(It&&"mousemove"===e.type?(_t=e.screenX-It.screenX,Ft=e.screenY-It.screenY):Ft=_t=0,It=e),_t)},movementY:function(e){return"movementY"in e?e.movementY:Ft}}),Nt=rd(Lt),Dt=rd(a({},Lt,{dataTransfer:0})),zt=rd(a({},At,{relatedTarget:0})),Qt=rd(a({},Tt,{animationName:0,elapsedTime:0,pseudoElement:0})),Vt=rd(a({},Tt,{clipboardData:function(e){return"clipboardData"in e?e.clipboardData:window.clipboardData}})),qt=rd(a({},Tt,{data:0})),Wt={Esc:"Escape",Spacebar:" ",Left:"ArrowLeft",Up:"ArrowUp",Right:"ArrowRight",Down:"ArrowDown",Del:"Delete",Win:"OS",Menu:"ContextMenu",Apps:"ContextMenu",Scroll:"ScrollLock",MozPrintableKey:"Unidentified"},Bt={8:"Backspace",9:"Tab",12:"Clear",13:"Enter",16:"Shift",17:"Control",18:"Alt",19:"Pause",20:"CapsLock",27:"Escape",32:" ",33:"PageUp",34:"PageDown",35:"End",36:"Home",37:"ArrowLeft",38:"ArrowUp",39:"ArrowRight",40:"ArrowDown",45:"Insert",46:"Delete",112:"F1",113:"F2",114:"F3",115:"F4",116:"F5",117:"F6",118:"F7",119:"F8",120:"F9",121:"F10",122:"F11",123:"F12",144:"NumLock",145:"ScrollLock",224:"Meta"},Ut={Alt:"altKey",Control:"ctrlKey",Meta:"metaKey",Shift:"shiftKey"}
...
if("Unidentified"!==t)return t}return"keypress"===e.type?13===(e=od(e))?"Enter":String.fromCharCode(e):"keydown"===e.type||"keyup"===e.type?Bt[e.keyCode]||"Unidentified":""},code:0,location:0,ctrlKey:0,shiftKey:0,altKey:0,metaKey:0,repeat:0,locale:0,getModifierState:zd,charCode:function(e){return"keypress"===e.type?od(e):0},keyCode:function(e){return"keydown"===e.type||"keyup"===e.type?e.keyCode:0},which:function(e){return"keypress"===e.type?od(e):"keydown"===e.type||"keyup"===e.type?e.keyCode:0}})),Gt=rd(a({},Lt,{pointerId:0,width:0,height:0,pressure:0,tangentialPressure:0,tiltX:0,tiltY:0,twist:0,pointerType:0,isPrimary:0})),Kt=rd(a({},At,{touches:0,targetTouches:0,changedTouches:0,altKey:0,metaKey:0,ctrlKey:0,shiftKey:0,getModifierState:zd})),$t=rd(a({},Tt,{propertyName:0,elapsedTime:0,pseudoElement:0})),Jt=rd(a({},Lt,{deltaX:function(e){return"deltaX"in e?e.deltaX:"wheelDeltaX"in e?-e.wheelDeltaX:0},deltaY:function(e){return"deltaY"in e?e.deltaY:"wheelDeltaY"in e?-e.wheelDeltaY:"wheelDelta"in e?-e.wheelDelta:0},deltaZ:0,deltaMode:0})),Yt=[9,13,27,32],Xt=m&&"CompositionEvent"in window,Zt=null
...
Ze(o,u,c),i=l}}}if(Qe)throw e=Ve,Qe=!1,Ve=null,e}function G(e,t){var r=$e(t),n=e+"__bubble"
...
return void 0===t&&(t=e[Rr]=new Set),t}var Ar=[],Mr=-1
function Bf(e){return{current:e}}function H(e){0>Mr||(e.current=Ar[Mr],Ar[Mr]=null,Mr--)}function I(e,t){Ar[++Mr]=e.current,e.current=t}var Lr={},Nr=Bf(Lr),Dr=Bf(!1),zr=Lr
...
Cn.length=0}var Pn=F.ReactCurrentDispatcher,_n=F.ReactCurrentBatchConfig,Fn=0,In=null,Tn=null,Rn=null,An=!1,Mn=!1
...
return!0}function Ch(e,t,r,n,o,i){if(Fn=i,In=t,t.memoizedState=null,t.updateQueue=null,t.lanes=0,Pn.current=null===e||null===e.memoizedState?Nn:Dn,e=r(n,o),Mn){i=0
do{if(Mn=!1,!(25>i))throw Error(y(301))
i+=1,Rn=Tn=null,t.updateQueue=null,Pn.current=zn,e=r(n,o)}while(Mn)}if(Pn.current=Ln,t=null!==Tn&&null!==Tn.next,Fn=0,Rn=Tn=In=null,An=!1,t)throw Error(y(300))
...
if(null===a?i.next=i:(i.next=a.next,a.next=i),t.pending=i,a=e.alternate,e===In||null!==a&&a===In)Mn=An=!0
...
var o=r}catch(e){o="\nError generating stack: "+e.message+"\n"+e.stack}return{value:e,source:t,stack:o}}function Ni(e,t){try{console.error(t.value)}catch(e){setTimeout(function(){throw e})}}qn=function(e,t){for(var r=t.child;null!==r;){if(5===r.tag||6===r.tag)e.appendChild(r.stateNode)
...
var n=t.value
return r.callback=function(){yo||(yo=!0,bo=n),Ni(0,t)},r}function Si(e,t,r){(r=zg(-1,r)).tag=3
...
r.has(t)||(r.add(t),t.then(n,n))})}}function mj(e,t){return null!==e&&(null===(e=e.memoizedState)||null!==e.dehydrated)&&(null!==(t=t.memoizedState)&&null===t.dehydrated)}var $n=Math.ceil,Jn=F.ReactCurrentDispatcher,Yn=F.ReactCurrentOwner,Xn=0,Zn=null,eo=null,to=0,ro=0,no=Bf(0),oo=0,io=null,ao=0,uo=0,lo=0,co=0,so=null,fo=0,po=1/0
function wj(){po=un()+500}var ho,vo=null,yo=!1,bo=null,go=null,mo=!1,Oo=null,wo=90,jo=[],So=[],ko=null,Eo=0,xo=null,Co=-1,Po=0,_o=0,Fo=null,Io=!1
...
try{if(qg(),Pn.current=Ln,An){for(var n=In.memoizedState;null!==n;){var o=n.queue
null!==o&&(o.pending=null),n=n.next}An=!1}if(Fn=0,Rn=Tn=In=null,Mn=!1,Yn.current=null,null===r||null===r.return){oo=1,io=t,eo=null
...
b.add(c),d.updateQueue=b}else y.add(c)
...
o[l]=0,a[l]=-1,u[l]=-1,i&=~c}if(null!==ko&&0==(24&n)&&ko.has(e)&&ko.delete(e),e===Zn&&(eo=Zn=null,to=0),1<r.flags?null!==r.lastEffect?(r.lastEffect.nextEffect=r,n=r.firstEffect):n=r:n=r.firstEffect,null!==n){if(o=Xn,Xn|=32,Yn.current=null,kr=Et,Oe(a=Ne())){if("selectionStart"in a)u={start:a.selectionStart,end:a.selectionEnd}
...
break e}var s=0,f=-1,d=-1,p=0,h=0,v=a,b=null
t:for(;;){for(var g;v!==u||0!==i&&3!==v.nodeType||(f=s+i),v!==l||0!==c&&3!==v.nodeType||(d=s+c),3===v.nodeType&&(s+=v.nodeValue.length),null!==(g=v.firstChild);)b=v,v=g
for(;;){if(v===a)break t
if(b===u&&++p===i&&(f=s),b===l&&++h===c&&(d=s),null!==(g=v.nextSibling))break
