...
window.requestAnimationFrame}var v=!1,w=null,m=-1,y=5,h=0
n.unstable_shouldYield=function(){return n.unstable_now()>=h},l=function(){},n.unstable_forceFrameRate=function(e){0>e||125<e||(y=0<e?Math.floor(1e3/e):5)}
var _=new MessageChannel,g=_.port2
_.port1.onmessage=function(){if(null!==w){var e=n.unstable_now()
h=e+y
try{w(!0,e)?g.postMessage(null):(v=!1,w=null)}catch(e){throw g.postMessage(null),e}}else v=!1},r=function(e){w=e,v||(v=!0,g.postMessage(null))},a=function(e,t){m=d(function(){e(n.unstable_now())},t)},o=function(){p(m),m=-1}}function H(e,n){var t=e.length
e.push(n)
...
P=n
try{return e.apply(this,arguments)}finally{P=t}}}},1:function(e,n,t){t("FASw"),e.exports=t("Xohm")},FASw:function(e,n,t){globalThis.__fetchLocaleData__=async function getLocale(e){if("en_US"===e)return t.e(7).then(t.t.bind(null,"5I32",3))
...
e.exports=t("+wdc")},Xohm:function(e,n,t){"use strict"
t.r(n),t.d(n,"default",function(){return l})
var r=t("q1tI"),a=t.n(r),o=t("i8i4"),l=e=>a.a.createElement("div",null,"Hello Cart")
Object(o.render)(a.a.createElement(l,null),document.querySelector(".block.commerce-cart"))}},[[1,0,1]]])
