...
// CONCATENATED MODULE: ./node_modules/@magento/peregrine/lib/talons/CheckoutPage/ShippingInformation/shippingInformationFragments.gql.js

const ShippingInformationFragment = lib["a" /* gql */]`
...
// CONCATENATED MODULE: ./node_modules/@magento/peregrine/lib/talons/CartPage/PriceAdjustments/ShippingMethods/shippingMethods.gql.js




const GET_SHIPPING_METHODS = lib["a" /* gql */]`
...
`;
const SET_SHIPPING_ADDRESS_MUTATION = lib["a" /* gql */]`
...
const useShippingMethods = (props = {}) => {
  const operations = Object(shallowMerge["a" /* default */])(shippingMethods_gql, props.operations);
  const {
...
// CONCATENATED MODULE: ./node_modules/@magento/peregrine/lib/talons/CartPage/PriceAdjustments/ShippingMethods/useShippingForm.js
...
const useShippingForm = props => {
  ...
  }] = Object(useMutation["a" /* useMutation */])(setShippingAddressMutation);
  Object(react["useEffect"])(() => {
   ...
   */
  const handleZipChange = Object(react["useCallback"])(zip => {
  ...
  const handleOnSubmit = Object(react["useCallback"])(formValues => {
    const {
      country,
      region,
      zip
  ...
  const errors = Object(react["useMemo"])(() => new Map([['setShippingAddressMutation', errorSettingShippingAddress]]), [errorSettingShippingAddress]);
  return {
    errors,
    handleOnSubmit,
    handleZipChange,
...
var shippingForm_module_options = {"injectType":"styleTag"};
...
function useShippingRadios_ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); enumerableOnly && (symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; })), keys.push.apply(keys, symbols); } return keys; }
function useShippingRadios_objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = null != arguments[i] ? arguments[i] : {}; i % 2 ? useShippingRadios_ownKeys(Object(source), !0).forEach(function (key) { useShippingRadios_defineProperty(target, key, source[key]); }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)) : useShippingRadios_ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } return target; }
function useShippingRadios_defineProperty(obj, key, value) { key = useShippingRadios_toPropertyKey(key); if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
function useShippingRadios_toPropertyKey(arg) { var key = useShippingRadios_toPrimitive(arg, "string"); return typeof key === "symbol" ? key : String(key); }
function useShippingRadios_toPrimitive(input, hint) { if (typeof input !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (typeof res !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }
...
const useShippingRadios = props => {
  ...
  const formattedShippingMethods = shippingMethods.map(shippingMethod => useShippingRadios_objectSpread(useShippingRadios_objectSpread({}, shippingMethod), {}, {
...
var radio_module_options = {"injectType":"styleTag"};

radio_module_options.insert = "head";
radio_module_options.singleton = false;

var radio_module_update = injectStylesIntoStyleTag_default()(radio_module["a" /* default */], radio_module_options);
...
/* harmony default export */ var RadioGroup_radio = (RadioOption);
...
var radioGroup_module_update = injectStylesIntoStyleTag_default()(radioGroup_module["a" /* default */], radioGroup_module_options);
...
const radioGroup_excluded = ["children", "classes", "disabled", "field", "id", "items", "message"],
  _excluded2 = ["value"];
...
const RadioGroup = props => {
  ...
  const options = children || items.map(_ref => {
    let {
      ...
      item = radioGroup_objectWithoutProperties(_ref, _excluded2);
    return /*#__PURE__*/react_default.a.createElement(RadioGroup_radio, radioGroup_extends({
      "data-cy": "",
      key: value,
      disabled: disabled
    }, item, {
  ...
  return /*#__PURE__*/react_default.a.createElement(react["Fragment"], null, /*#__PURE__*/react_default.a.createElement("div", {
    ...
    className: classes.root
  }, /*#__PURE__*/react_default.a.createElement(esm["e" /* RadioGroup */], radioGroup_extends({}, rest, {
    field: field,
    id: id
  }), options)), /*#__PURE__*/react_default.a.createElement(Field_message["a" /* default */], {
...
var shippingRadio_module_options = {"injectType":"styleTag"};

shippingRadio_module_options.insert = "head";
shippingRadio_module_options.singleton = false;

var shippingRadio_module_update = injectStylesIntoStyleTag_default()(shippingRadio_module["a" /* default */], shippingRadio_module_options);
...
/* harmony default export */ var shippingRadio = (ShippingRadio);
...
const ShippingRadios = props => {
  ...
  const radioComponents = formattedShippingMethods.map(shippingMethod => {
    return {
      label: /*#__PURE__*/react_default.a.createElement(shippingRadio, {
  ...
  return /*#__PURE__*/react_default.a.createElement(radioGroup, {
