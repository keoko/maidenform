...
/*!*******************************************************************************************************************!*\
  !*** ./node_modules/@magento/venia-ui/lib/components/CartPage/PriceAdjustments/GiftOptions/index.js + 11 modules ***!
  \*******************************************************************************************************************/
...
var spinner_module_options = {"injectType":"styleTag"};

spinner_module_options.insert = "head";
spinner_module_options.singleton = false;

var spinner_module_update = injectStylesIntoStyleTag_default()(spinner_module["a" /* default */], spinner_module_options);
...
const Spinner = props => {
  ...
  return /*#__PURE__*/react_default.a.createElement(Icon_icon["a" /* default */], {
...
var textArea_module_options = {"injectType":"styleTag"};

textArea_module_options.insert = "head";
textArea_module_options.singleton = false;

var textArea_module_update = injectStylesIntoStyleTag_default()(textArea_module["a" /* default */], textArea_module_options);
...
const textArea_excluded = ["classes", "field", "message"];
...
const TextArea = props => {
  const {
    ...
    rest = textArea_objectWithoutProperties(props, textArea_excluded);
  const fieldState = Object(useInformedFieldStateWrapper["a" /* default */])(field);
  const classes = Object(shallowMerge["a" /* default */])(TextArea_textArea_module, propClasses);
  return /*#__PURE__*/react_default.a.createElement(react["Fragment"], null, /*#__PURE__*/react_default.a.createElement(esm["i" /* TextArea */], textArea_extends({}, rest, {
    className: classes.input,
    field: field
...
const GiftOptions = props => {
  ...
  }, /*#__PURE__*/react_default.a.createElement(Checkbox_checkbox, giftOptions_extends({}, giftReceiptProps, {
  ...
  const includeGiftMessage = allow_order === '1' ? /*#__PURE__*/react_default.a.createElement(react_default.a.Fragment, null, /*#__PURE__*/react_default.a.createElement("div", {
    ...
    className: classes.checkboxContainer
  }, /*#__PURE__*/react_default.a.createElement(Checkbox_checkbox, giftOptions_extends({}, giftMessageCheckboxProps, {
  ...
  }), /*#__PURE__*/react_default.a.createElement(Icon_icon["a" /* default */], {
    classes: {
      icon: null
    },
    size: 16,
  ...
  const includePrintedCard = allow_printed_card === '1' ? /*#__PURE__*/react_default.a.createElement("div", {
    ...
    className: classes.checkboxContainer
  }, /*#__PURE__*/react_default.a.createElement(Checkbox_checkbox, giftOptions_extends({}, printedCardProps, {
