...
"function"!=typeof window.requestAnimationFrame&&console.error("This browser doesn't support requestAnimationFrame. Make sure that you load a polyfill in older browsers. https://reactjs.org/link/react-polyfills"),"function"!=typeof w&&console.error("This browser doesn't support cancelAnimationFrame. Make sure that you load a polyfill in older browsers. https://reactjs.org/link/react-polyfills")}var v=!1,y=null,m=-1,h=5,_=0
n.unstable_shouldYield=function(){return n.unstable_now()>=_},l=function(){},n.unstable_forceFrameRate=function(e){0>e||125<e?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):h=0<e?Math.floor(1e3/e):5}
...
return 0!==t?t:e.id-n.id}var j=[],O=[],x=1,P=null,C=3,F=!1,M=!1,A=!1
function T(e){for(var n=J(O);null!==n;){if(null===n.callback)K(O)
else{if(!(n.startTime<=e))break
K(O),n.sortIndex=n.expirationTime,H(j,n)}n=J(O)}}function U(e){if(A=!1,T(e),!M)if(null!==J(j))M=!0,r(V)
else{var n=J(O)
null!==n&&o(U,n.startTime-e)}}function V(e,t){M=!1,A&&(A=!1,a()),F=!0
var r=C
...
case 4:u=1e4
break
default:u=5e3}return e={id:x++,callback:t,priorityLevel:e,startTime:l,expirationTime:u=l+u,sortIndex:-1},l>i?(e.sortIndex=l,H(O,e),null===J(j)&&e===J(O)&&(A?a():A=!0,o(U,l-i))):(e.sortIndex=u,H(j,e),M||F||(M=!0,r(V))),e},n.unstable_wrapCallback=function(e){var n=C
return function(){var t=C
C=n
try{return e.apply(this,arguments)}finally{C=t}}}},3:function(e,n,t){t("FASw"),e.exports=t("wj6O")},FASw:function(e,n,t){globalThis.__fetchLocaleData__=async function getLocale(e){if("en_US"===e)return t.e(6).then(t.t.bind(null,"5I32",3))
...
var r=t("q1tI"),o=t.n(r),a=t("i8i4"),l=e=>o.a.createElement("div",null,"Hello Account")
console.log("Account Loaded"),Object(a.render)(o.a.createElement(l,null),document.querySelector(".block.commerce-account"))}},[[3,0,1]]])
